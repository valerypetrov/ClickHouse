...
SELECT 'Kelvin sign needle', positionCaseInsensitiveUTF8(materialize('k'), unhex('E284AA')), positionCaseInsensitiveUTF8(materialize('k'), materialize(unhex('E284AA'))), positionCaseInsensitiveUTF8('k', materialize(unhex('E284AA')));
